...
let WebhooksController = class WebhooksController {
    ...
    async receiveIncident(webhookDto) {
        const orgId = webhookDto.orgId;
...
__decorate([
    ...
    __metadata("design:paramtypes", [dto_1.IncomingWebhookDto]),
    __metadata("design:returntype", Promise)
], WebhooksController.prototype, "receiveIncident", null);
