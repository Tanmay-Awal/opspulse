...
export declare class RemediationService {
    private prisma;
    private aiAnalyzer;
    private playbookMatcher;
    private executionEngine;
    private auditService;
    constructor(prisma: PrismaService, aiAnalyzer: AiAnalyzerService, playbookMatcher: PlaybookMatcherService, executionEngine: ExecutionEngineService, auditService: AuditService);
    analyzeAndPropose(incidentId: string): Promise<{
        hasPlaybook: boolean;
    ...
    executeRemediation(executionId: string, approvedBy?: string): Promise<{
        success: boolean;
        executionId: string;
        status: string;
    }>;
    rejectRemediation(executionId: string, rejectedBy: string, reason?: string): Promise<{
        message: string;
    }>;
    rollbackRemediation(executionId: string, rolledBackBy: string): Promise<{
        success: boolean;
        message: string;
    }>;
    ...
    learnFromResolution(incidentId: string, learnedBy: string, data: {
        playbookName: string;
        description: string;
        steps: any[];
    ...
    suggestPlaybookFromResolution(incidentId: string): Promise<{
        suggested: boolean;
        playbook: any;
        confidence: number;
    }>;
    ...
    improvePlaybook(playbookId: string, feedback: {
